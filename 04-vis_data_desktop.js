//VISUALIZAÇÃO DE DADOS & INTERAÇÃO USER - desktop


function visDataDesktop()
{    
  world.update();
  ...
  text (elemento.year, my_range_slider.thumb().x, my_range_slider.thumb().y - 35);
